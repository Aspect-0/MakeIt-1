  ...
  <div class="form" >
    ...
    <div class="subDiv">
      ...
      <div class="username">
        ...
        <input class="input" type="text" v-model="usernameValue" placeholder="Username" >

      </div>
      <div class="password">
        <h2 class="subTitle">Password</h2>
        <input class="input" type="password" v-model="passwordValue" placeholder="Password">

      </div>

    </div>

    <button class="button" @click="sendSignupData({username: usernameValue, password: passwordValue})" ><div>Sign Up</div></button>
...
.svg-bottom{
    ...
    background-image: url(../assets/signup-top-left-wave.svg);
}
